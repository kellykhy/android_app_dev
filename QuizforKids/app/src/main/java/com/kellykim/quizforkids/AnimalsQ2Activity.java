...
public class AnimalsQ2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animals_q2);
        ...
        txtAnimal2 = (EditText)findViewById(R.id.txtAnimal2);
        ...
        n2 = intent.getExtras().getInt(AnimalsQ1Activity.N2);
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.menu_select_info) {
            ...
            Intent intent1 = new Intent(this, AnimalsQ3Activity.class);
    ...
    public void setQuestion(){
        Cursor res = myDB.viewRecord_1(n2);
        if (res.getCount() == 0){
        ...
        animal2.setImageResource(id);
    }

    public boolean isCorrect(){
        Cursor res = myDB.viewRecord_1(n2);
        res.moveToFirst();
        if (txtAnimal2.getText().toString().equals(res.getString(1)))
            return true;
        else
            return false;
    }
