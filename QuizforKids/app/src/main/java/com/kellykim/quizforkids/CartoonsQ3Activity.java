...
public class CartoonsQ3Activity extends AppCompatActivity {
    int user_id;
    int n3, n4;
    int correct_answers;
    int flag = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cartoons_q3);
        ...
        Cartoons3Q = (TextView) findViewById(R.id.Cartoons3Q);
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.menu_select_info) {
            ...
            Intent intent1 = new Intent(this, CartoonsQ4Activity.class);
    ...
    public void setQuestion(){
        Cursor res = myDB.viewRecord_2(n3);
        if (res.getCount() == 0){
            message.showMessage(this, "Error", "No record found");
            return;
        }
        res.moveToFirst();
        Cartoons3Q.setText(res.getString(1));
